...
""")
    ...
    def loadMessages(self):
        ...
        # Find only the new message
            new_message = messages.replace(old_chat_message, '')
            self.addMessage(message=new_message.strip(), color='White')
...
class CustomTopBar(QWidget):
    ...
    def initUI(self):
        ...
        self.maximize_button.clicked.connect(self.closeWindow)
